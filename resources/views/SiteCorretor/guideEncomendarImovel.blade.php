...
<head>
    ...
    <title>Guide Home - Página Encomendar Imóvel</title>
      ...
      <section class="container colorText">
        <div class="containerFlex">
          <div class="containerEncomendar">
            <h1 class="titleEncomendar">Encomende um Imóvel</h1>
            <form action="">
                <div class="top">
                ...
                <div class="bottom">
                    <h2 class="subTitle">Sobre o imóvel que procura</h2>
                    ...
                    <div class="inputBox textareaBox">
                        <label for="descreva" class="label">Descreva</label>
                        <textarea name="descreva" id="descreva" placeholder="Desejo um apartamento com 2 dormitórios, 2 vagas, com..." class="input textarea" required></textarea>
                    </div>
                </div>
